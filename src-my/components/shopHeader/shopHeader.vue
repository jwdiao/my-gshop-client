    ...
    <div class="activity-sheet" v-show="isShowSupport">
      <div class="activity-sheet-content">
        ...
        <ul class="list" v-if="info.supports">
          <li class="activity-item activity-green" v-for="(support,index) in info.supports" :key="index" :class="addClass[support.type]">
            <span class="content-tag">
  ...
  export default {
    data() {
      return {
        ...
        addClass:["activity-green","activity-red","activity-orange"]
      }
    },
    computed:{
      ...mapState(['info']),
